...
import (
	...
	"github.com/joegruffins/go-ethereum/crypto/signify"
	"github.com/joegruffins/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/joegruffins/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/joegruffins/go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/joegruffins/go-ethereum/core/rawdb", "github.com/joegruffins/go-ethereum/ethdb/leveldb"},
		{"github.com/joegruffins/go-ethereum/core/rawdb", "github.com/joegruffins/go-ethereum/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
